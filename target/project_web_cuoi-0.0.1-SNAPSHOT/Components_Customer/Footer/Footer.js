            ...
            <div class="row">
                ...
                <div class="col-sm item1">
                    <div class="col__item">
                        <h5>INFORMATION</h5>
                        <div class="row">
                            <a href="AboutUsForward">About Us</a>
                            <a href="PolicyForward">Privacy Policy</a>
                            <a href="TermForward">Tearms & Conditions</a>
                            <a href="ContactForward">Contact Us</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm">
                    <div class="col__item">
                        <h5>MY ACCOUNT</h5>
                        <div class="row">
                            <a href="CheckLoginController">My Account</a>
                            
                            <a href="OrderHistoryForward">Order history</a>
                        </div>
                    </div>
                </div>
            </div>
